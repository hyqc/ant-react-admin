...
import { adminMenuMode, AdminMenuModePagesItemType } from '@/services/apis/admin/menu';
...
const MenuPagePermissions: React.FC<EditModalPropsType> = (props) => {
  const [form] = Form.useForm();
  const { modalStatus, detailData, noticeModal } = props;
  const [confirmLoading, setConfirmLoading] = useState<boolean>(false);
  const [modeData, setMenuModeData] = useState<AdminMenuModePagesItemType[]>();
...
export default MenuPagePermissions;
